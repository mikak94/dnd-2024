...
You can cast [Speak with Dead](/spell:speak-with-dead) once without a spell slot, requiring no spell components and using Dexterity as the spellcasting modifier. You regain the ability to cast it this way when you finish a Short or Long Rest.

...
| ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 3             | [Detect Thoughts](/spell:detect-thoughts), [Dissonant Whispers](/spell:dissonant-whispers), [Phantasmal Force](/spell:phantasmal-force), [Tasha's Hideous Laughter](/spell:tasha-s-hideous-laughter) |
| 5             | [Clairvoyance](/spell:clairvoyance), [Hunger of Hadar](/spell:hunger-of-hadar)                                                                                                                       |
| 7             | [Confusion](/spell:confusion), [Summon Aberration](/spell:summon-aberration)                                                                                                                         |
| 9             | [Modify Memory](/spell:modify-memory), [Telekinesis](/spell:telekinesis)                                                                                                                             |
...
Your alien patron grants you a powerful curse. You always have the [Hex](/spell:hex) spell prepared. When you cast Hex and choose an ability, the target also has Disadvantage on saving throws of the chosen ability for the duration of the spell.
...
When you cast [Summon Aberration](/spell:summon-aberration), you can modify it so that it doesn’t require Concentration. If you do so, the spell’s duration becomes 1 minute for that casting, and when summoned, the Aberration has a number of Temporary Hit Points equal to your Warlock level plus your Charisma modifier.

In addition, the first time each turn the Aberration hits a creature under the effect of your [Hex](/spell:hex), the Aberration deals extra Psychic damage to the target equal to the bonus damage of that spell.

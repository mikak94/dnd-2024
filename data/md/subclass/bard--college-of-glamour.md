...
You always have the [Charm Person](/spell:charm-person) and [Mirror Image](/spell:mirror-image) spells prepared.
...
You always have the [Command](/spell:command) spell prepared.

As a Bonus Action, you cast [Command](/spell:command) without expending a spell slot, and you take on an unearthly appearance for 1 minute or until your Concentration ends. During this time, you can cast [Command](/spell:command) as a Bonus Action without expending a spell slot,

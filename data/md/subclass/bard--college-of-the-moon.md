...
You always have the [Moonbeam](/spell:moonbeam) spell prepared.

When you cast [Moonbeam](/spell:moonbeam), you can modify the spell so that you glow faintly while the spell is active. While glowing, you shed Dim Light out to 5 feet, and whenever a creature fails its saving throw against the effects of this Moonbeam, another creature of your choice that you can see within 60 feet of yourself regains 2d4 Hit Points.

Once you use this feature to modify a casting of [Moonbeam](/spell:moonbeam), you can’t use it again until you finish a Long Rest.

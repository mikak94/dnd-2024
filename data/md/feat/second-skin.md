...
When you cast [Alter Self](/spell:alter-self) without a spell slot using this feature, it doesn’t require Concentration.
...
After you experience the catalyst, at the start of your next turn, make a Charisma saving throw (DC 13 plus your Proficiency Bonus). On a failed save, you immediately use Alternate Form to cast [Alter Self](/spell:alter-self) without a spell slot. If you’ve already expended the use of that feature, you instead have the Stunned condition until the start of your next turn.

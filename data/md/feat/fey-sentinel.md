...
_General Feat (Prerequisite: Level 4+, [Fey Pact](/feat:fey-pact) Feat)_
...
**Nature’s Roots.** You always have the [Entangle](/spell:entangle) spell prepared. You can cast it once without a spell slot, and you regain the ability to cast it in that way when you finish a Long Rest. You can also cast it using any spell slots you have. The spell’s spellcasting ability is the ability increased by this feat.

When you reach character level 5, you also always have the [Plant Growth](/spell:plant-growth) spell prepared and can cast it the same way.

...
**Spirit Whispers.** You learn the [Message](/spell:message) spell and can cast it without Material components. Additionally, you always have the [Augury](/spell:augury) spell prepared. You can cast it without a spell slot or spell components, and you must finish a Long Rest before you can cast it in this way again. You can also cast the spell using any spell slots you have.  

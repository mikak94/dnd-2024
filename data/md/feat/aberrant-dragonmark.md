...
_Dragonmark Feat (Prerequisite: Eberron Campaign, Can’t Have Another Dragonmark Feat)_
...
**Aberrant Magic.** You know one cantrip of your choice from the [Sorcerer spell list](/sorcerer:spell-list). Also, choose a level 1 spell from that spell list. You always have that spell prepared. You can cast it once without a spell slot, and you regain the ability to cast it in that way when you finish a Short or Long Rest. You can also cast this spell using any spell slots you have. Constitution is your spellcasting ability for this spell.

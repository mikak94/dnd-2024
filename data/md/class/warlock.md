...
- Gain the Warlock's level 1 features, which are listed in the Warlock Features table. See the multiclassing rules in [multiclassing](/class:multiclassing) to determine your available spell slots.
...
**Cantrips.** You know two Warlock cantrips of your choice. [Eldritch Blast](/spell:eldritch-blast) and [Prestidigitation](/spell:prestidigitation) are recommended. Whenever you gain a Warlock level, you can replace one of your cantrips from this feature with another Warlock cantrip of your choice.
...
For example, when you’re a level 5 Warlock, you have two level 3 spell slots. To cast the level 1 spell [Witch Bolt](/spell:witch-bolt), you must spend one of those slots, and you cast it as a level 3 spell.

**Prepared Spells of Level 1+.** You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose two level 1 Warlock spells. [Charm Person](/spell:charm-person) and [Hex](/spell:hex) are recommended.
...
| [Undead Patron](/warlock:undead-patron)               |

### Level 4: Ability Score Improvement

You gain the [Ability Score Improvement feat](/feat:ability-score-improvement) or another [feat of your choice](/feat:all) for which you qualify. You gain this feature again at Warlock levels 8, 12, and 16.
...
You gain an [Epic Boon feat](/feat:all) or another feat of your choice for which you qualify. [Boon of Fate](/feat:boon-of-fate) is recommended.

...
_Wondrous Item, Uncommon (Silver) or Rare (Golden) (Requires Attunement)_
...
**Golden Harper Pin.** While wearing this pin, you can cast the [Nondetection](/spell:nondetection) spell on yourself. The duration of this spell is permanent until you disable the effect (no action required), you remove the pin, or you are no longer attuned to the pin.

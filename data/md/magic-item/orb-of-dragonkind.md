...
While you are Charmed by the orb, you can’t voluntarily end your Attunement to it, and the orb casts [Suggestion](/spell:suggestion) on you at will (save DC 18), urging you to work toward the evil ends it desires. The dragon essence within the orb might want many things: the annihilation of a particular society or organization, freedom from the orb, to spread suffering in the world, to advance the worship of Tiamat, or something else the DM decides.

**Random Properties.** An _Orb of Dragonkind_ has the following random properties (see “Artifacts”):
...
| Spell                                               | Charge Cost |
| --------------------------------------------------- | ----------- |
| [Cure Wounds](/spell:cure-wounds) (level 9 version) | 4           |
| [Daylight](/spell:daylight)                         | 1           |
| [Death Ward](/spell:death-ward)                     | 2           |
| [Detect Magic](/spell:detect-magic)                 | 0           |
| [Scrying](/spell:scrying) (save DC 18)              | 3           |
...
**Destroying an Orb.** An _Orb of Dragonkind_ has AC 20 and is destroyed if it takes damage from a [+3 Weapon](/magic-item:weapon-1-2-or-3) or a [Disintegrate](/spell:disintegrate) spell. Nothing else can harm it.

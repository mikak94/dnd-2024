...
**Sphere Interactions.** If the sphere comes into contact with a planar portal (such as that created by the [Gate](/spell:gate) spell) or an extradimensional space (such as that within a [Portable Hole](/magic-item:portable-hole)), the DM determines randomly what happens using the following table.

...
Alternatively, when you light the candle for the first time, you can cast [Gate](/spell:gate) with it. Doing so destroys the candle. The portal created by the spell links to a particular Outer Plane chosen by the DM or determined by rolling on the following table.

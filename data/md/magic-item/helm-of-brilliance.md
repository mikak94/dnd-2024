...
**Spells.** You can cast one of the following spells (save DC 18), using one of the helm’s gems of the specified type as a component: [Daylight](/spell:daylight) (opal), [Fireball](/spell:fireball) (fire opal), [Prismatic Spray](/spell:prismatic-spray) (diamond), or [Wall of Fire](/spell:wall-of-fire) (ruby). The gem is destroyed when the spell is cast and disappears from the helm.
